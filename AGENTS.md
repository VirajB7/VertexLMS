...
Your job is to understand the request, use the right projects skills, write a clear implementation prompt, get approval, then implement.
...
Do not write code before the prompt is approved, unless the user tell you to skip the prompt.
